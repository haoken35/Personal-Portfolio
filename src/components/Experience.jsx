...
const Experience = () => {
  ...
  return (
    <div className="relative py-20 px-96">
      ...
      />
      <div ref={containerRef} className="w-full h-full  flex flex-col items-center justify-center gap-y-10 lg:gap-t-20 py-10">
        {experienceData.map((data, i) => (
          ...
          >
            <motion.div 
              ...
              <div className="text-gray-800">
                ...
                <ul className="pl-2">
                  {data.experience.map((exp, j) => (
                    <li key={j} className="py-1 font-extralight">
                      {exp}
                    </li>
                  ))}
                </ul>
              ...
              <span
                className={
                  `absolute top-20 text-red-300 translate-y-1/2 ${ i % 2 === 0 ? 'left-full -translate-x-1/2 lg:left-1/2' : 'right-full translate-x-1/2 lg:right-1/2'}`
                }
              >
                {arrowLeftIcon}
              </span>
